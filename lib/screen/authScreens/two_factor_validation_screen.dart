...
class _TwoFactorValidationScreenState extends State<TwoFactorValidationScreen> {
  ...
  emailVerification() {
    if (formKey.currentState!.validate()) {
      ...
      }, url: ApiUrls.emailVerificationUrl, context: context,showResponse: true)
          .then((value) async {
                    ...
                    children: [
                      ...
                      Column(
                        ...
                        children: [
                          ...
                          addHeight(35),
                           AddText(
                            text: 'We\'ve sent an email to ${signUpController.emailController.text.trim().toString()} with a 6 digit code. This can take several minutes to receive. Please enter the code below or tap the link in the email.',
                            fontSize: 12,
